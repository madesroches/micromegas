            ...
            <div className="p-4">
              ...
              <div className="mt-4">
                ...
                <div className="text-xs text-theme-text-muted space-y-1">
                  {VARIABLES.map((v) => (
                    <div key={v.name}>
                      <code className="px-1.5 py-0.5 bg-theme-border rounded-sm text-accent-variable">${v.name}</code> -{' '}
                      {v.description}
                    </div>
                  ))}
                </div>
              ...
              <div className="mt-4">
                ...
                <div className="text-xs text-theme-text-muted space-y-1">
                  {Object.entries(currentValues).map(([key, value]) => (
                    <div key={key}>
                      <code className="px-1.5 py-0.5 bg-theme-border rounded-sm text-accent-variable">${key}</code> ={' '}
                      <span className="text-theme-text-secondary">{value}</span>
                    </div>
                  ))}
                  <div>
                    <code className="px-1.5 py-0.5 bg-theme-border rounded-sm text-accent-variable">$order_by</code> ={' '}
