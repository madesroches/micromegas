...
export type CellType = 'table' | 'chart' | 'log' | 'markdown' | 'variable' | 'propertytimeline' | 'swimlane' | 'perfettoexport' | 'referencetable' | 'hg' | 'transposed'
...
export interface QueryCellConfig extends CellConfigBase {
  type: 'table' | 'chart' | 'log' | 'propertytimeline' | 'swimlane' | 'transposed'
  sql: string
...
export interface HorizontalGroupCellConfig extends CellConfigBase {
  type: 'hg'
  children: CellConfig[]
}

export type CellConfig = QueryCellConfig | MarkdownCellConfig | VariableCellConfig | PerfettoExportCellConfig | ReferenceTableCellConfig | HorizontalGroupCellConfig
