...
use crate::env::{reject_removed_admin_vars, resolve_prefixed_var};
...
impl ProviderBuilder {
    ...
    ///
    /// Refuses via [`reject_removed_admin_vars`] before composing anything: admin membership
    /// lives in the `admins` group from schema v10 on, and the three env-var admin lists this
    /// plan removes must never silently be ignored.
