...
| `MICROMEGAS_SELF_SERVICE_MAX_GRANTS_PER_CALLER` | No | Caps how many rows one non-admin caller may have created in `audience_grants`, counted across every audience/axis/selector (default `50`) |
