...
Click the **Add Cell** button below the cell list to add a new cell. Choose from the [16 available cell types](cell-types.md).
...
- [Cell Types](cell-types.md) — reference for all 16 cell types
